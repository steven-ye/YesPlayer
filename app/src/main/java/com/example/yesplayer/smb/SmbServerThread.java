...
import com.example.yesplayer.smb.http.HttpResponse;
import com.example.yesplayer.smb.http.HttpSocket;
import com.example.yesplayer.smb.http.HttpStatus;
...
public class SmbServerThread extends Thread {
    ...
    //获取视频内容及信息的接口
    private final HttpContentListener httpContent;
